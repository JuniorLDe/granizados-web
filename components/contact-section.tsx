      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Encuentranos o contactanos para hacer tu pedido
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="neon-card rounded-xl p-6 text-center">
            ...
            <p className="text-muted-foreground">Los Jardines</p>
            <p className="text-sm text-muted-foreground">Cartagena, Colombia</p>
          </div>
          ...
          <div className="neon-card rounded-xl p-6 text-center">
            ...
            <p className="text-muted-foreground">Viernes a Domingo</p>
            <p className="text-sm text-muted-foreground">5:00 PM - 12:00 AM</p>
          </div>
        </div>

        <div className="mt-12 text-center">
          <a
            href="https://wa.me/573107083539"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-green-600 hover:bg-green-700 text-white font-medium transition-colors"
          >
